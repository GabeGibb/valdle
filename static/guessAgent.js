...
let abilityUrl = window.env.API_URL + "/guessAgent/api/agentOfDay";
...
$.get(abilityUrl, function (data, status) {
...
function isCorrectAgentOption(userInputUPPER) {
	...
	let correctAnswers = [
		optionAnswer,
		genderMap[optionAnswer],
		dataList[randIndex]["role"]["displayName"],
		dateMap[optionAnswer],
	];
	let guessList = [
		userInput,
		genderMap[userInputUPPER],
		dataList[findUserIndex(userInputUPPER)]["role"]["displayName"],
		dateMap[userInputUPPER],
	];
